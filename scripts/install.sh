...
echo "==================================="
echo ""
echo "If you see 'b' characters instead of Option key behavior,"
echo "the app needs Accessibility permissions."
echo ""
echo "1. Open System Settings -> Privacy & Security -> Accessibility"
echo "2. If FootPedalOptionKey.app is listed, REMOVE it first"
echo "3. Click '+' and add /Applications/FootPedalOptionKey.app"
echo "4. Ensure it's toggled ON"
echo ""
echo "NOTE: You must re-add permissions after each reinstall."
echo ""
